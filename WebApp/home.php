...
<body>
    ...
    <select name="province_name" id="province_name">
        ...
        <?php
        $url = "http://192.168.10.5:9999/provinces";
        $curl = curl_init($url);
    ...
    <script>
        ...
        provinceDropdown.onchange = function () {
            ...
            var url = "http://192.168.10.5:9999/cities?province_name=" + selectedProvince;
        ...
        cityDropdown.onchange = function () {
            ...
            var url = "http://192.168.10.5:9999/locations?city=" + selectedCity;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", url, true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        locationDropdown.onchange = function () {
            ...
            var url = "http://192.168.10.5:9999/coordinates?city=" + cityDropdown.value + "&location=" + selectedLocation;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", url, true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        predictButton.onclick = function () {
            ...
            var url = "http://192.168.10.5:9999/predict?location=" + locationDropdown.value + "&city=" + cityDropdown.value + "&province_name=" + provinceDropdown.value + "&latitude=" + latitude + "&longtitude=" + longitude + "&baths=" + baths + "&areas_sqft=" + areas_sqft + "&bedrooms=" + bedrooms;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", url, true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
